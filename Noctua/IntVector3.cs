...
namespace Carina
{
    public struct IntVector3 : IEquatable<IntVector3>
    {
        ...
        public static readonly IntVector3 One = new IntVector3(1);

        public static readonly IntVector3 Top = new IntVector3(0, 1, 0);

        public static readonly IntVector3 Bottom = new IntVector3(0, -1, 0);

        public static readonly IntVector3 Front = new IntVector3(0, 0, 1);
